<?php
class TiempoData {
	public static $tablename = "tiempo";



	public function TiempoData(){
		$this->nombre = "";
	}

	public function add(){
		$sql = "insert into tiempo (nombre) ";
...
// partiendo de que ya tenemos creado un objecto CategoriaData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new TiempoData());
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new TiempoData());
	}

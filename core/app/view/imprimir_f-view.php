                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="index.php?view=recepcion"><i class="fa fa-home"></i> Inicio</a>
                                </li>
                                <li> 
                                    <a href="index.php?view=recepcion">Check out</a>
                                </li>
                                <li>
                                    <a href="reporte/ticket.php?id=<?php echo $_GET['id']; ?>"><?php echo $operacion->getComprobante()->nombre; ?></a>
                                </li>
                            </ul>
                        ...
                        <div class="add-nav">
                                                        ...
                                                        <div class="row b-t pt-20">
                                                            ...
                                                            <div class="col-md-5">
                                                               ...
                                                               <ul class="list-unstyled text-default lt mb-20">
                                                                    ...
                                                                    <li><strong class="inline-block w-xs">Vehiculo:</strong>  <?php echo $operacion->getCliente()->nacionalidad; ?></li>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th><b class="pull-right">Total</b></th>
                                </tr>
                                </thead>
                                <tbody>
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                           ...
                                                           <?php $desc= ($total_total*$operacion->descuento)/100;?>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">SUBTOTAL:</strong> $    <?php echo number_format($final,2,'.',','); ?> </li>

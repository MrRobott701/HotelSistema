...
<!-- tile -->
    ...
    padding: 20px 15px !important;">
                                ...
                                <!-- tile body -->
                                <div class="tile-body">
                                    <form role="form" autocomplete="off" class="form-validate-jquery" method="post" action="index.php?view=addcompra"   enctype="multipart/form-data" >
						...
						-->
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-12"> 
										<label>Adjuntar boleta foto</label>
										 <div class="form-group">
						                    <div class="input-group">

  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>DIRECTORIO DE CLIENTES</strong></h1>
        <ul class="controls">
          <li class="remove">
        ...
        <table class="table table-custom" id="editable-usage" style="font-size: 18px;">
            <thead >
                <tr>
                  ...
                  <th data-hide='phone, tablet'>Vehiculo</th> 
              ...
              <tbody>
                <?php foreach($clientes as $cliente):?> 
                      <tr>
                        ...
                        <td><?php if($cliente->nacionalidad!=NULL){ echo $cliente->nacionalidad;}else{ echo "--------";} ?></td>
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->nacionalidad; ?>" name="nacionalidad"  placeholder="MARCA / MODELO / COLOR / PLACA">
                    </div>
                  </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header"> 
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><span class="fa fa-users"></span> INGRESA NUEVO CLIENTE</h4>
              </div>
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group"> 
                    <!--<div class="input-group">
                      ...
                      <select name="medio_transporte" required class="form-control">
                        <option value="Empresa" >Empresario</option>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Vehiculo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control col-md-8" name="nacionalidad"  placeholder="MARCA / MODELO / COLOR / PLACA">
                    </div>
                  </div>

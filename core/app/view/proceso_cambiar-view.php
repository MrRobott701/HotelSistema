    ...
    <!-- tile -->            <section class="tile col-md-6">
                            ...
                            <form method="post" action="index.php?view=reporte_fecha_barra" >
                                <div class="tile-body">
                                    ...
                                    <h4 class="custom-font"><strong>Tipo habitación: <?php echo $habitacion->getHabitacion()->getCategoria()->nombre.' / Tarifa: '. $habitacion->getTarifa()->nombre; ?></strong></h4>

                                    <h4 class="custom-font"><strong>Costo alojamiento: $   <?php echo number_format($habitacion->precio,2,'.',','); ?></strong></h4>
                                    

                                    <h4 class="custom-font"><strong>Cant. noches: <?php echo $habitacion->cant_noche; ?></strong></h4>
                                    

                                    <h4 class="custom-font"><strong>Total: $   <?php echo number_format($habitacion->precio*$habitacion->cant_noche,2,'.',','); ?></strong></h4>
                            ...
                            <section class="tile col-md-6 ">
                               ...
                               <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>HABITACIÓN  a cambiarse</strong></h1>
                                    <ul class="controls">

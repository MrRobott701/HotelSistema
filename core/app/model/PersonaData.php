...
class PersonaData {
	...
	public function addCliente(){
	 ...
	 public function addClientenuevo(){
		$sql = "insert into persona (tipo_documento,documento,nombre,motivo,fecha_nac,giro,direccion,tipo,estado_civil,num_reserva,fecha_creada,medio_transporte,nacionalidad) ";
		$sql .= "value ($this->tipo_documento,\"$this->documento\",\"$this->nombre\",\"$this->motivo\",\"$this->fecha_nac\",\"$this->giro\",\"$this->direccion\",1,\"$this->estado_civil\",\"$this->num_reserva\",$this->fecha_creada,\"$this->medio_transporte\",\"$this->nacionalidad\")";
		return Executor::doit($sql);
	}

	public function addClienteResidente(){
		$sql = "insert into persona (tipo_documento,documento,nombre,motivo,fecha_nac,giro,direccion,tipo,estado_civil,num_reserva,fecha_creada,medio_transporte,razon_social,nacionalidad,ocupacion,destino,telefono,celular,alergia) ";
		$sql .= "value ($this->tipo_documento,\"$this->documento\",\"$this->nombre\",\"$this->motivo\",\"$this->fecha_nac\",\"$this->giro\",\"$this->direccion\",5,\"$this->estado_civil\",\"$this->num_reserva\",$this->fecha_creada,\"$this->medio_transporte\",\"$this->razon_social\",\"$this->nacionalidad\",\"$this->ocupacion\",\"$this->destino\",\"$this->telefono\",\"$this->celular\",\"$this->alergia\")";
		return Executor::doit($sql);
	}
	...
	public function add(){
		$sql = "insert into persona (tipo_documento,documento,nombre,giro,direccion,tipo,fecha_creada,nacionalidad,estado_civil,num_reserva,ocupacion,medio_transporte,destino,motivo) ";
		$sql .= "value ($this->tipo_documento,\"$this->documento\",\"$this->nombre\",\"$this->giro\",\"$this->direccion\",1,$this->fecha_creada,\"$this->nacionalidad\",\"$this->estado_civil\",\"$this->num_reserva\",\"$this->ocupacion\",\"$this->medio_transporte\",\"$this->destino\",\"$this->motivo\")";
		return Executor::doit($sql);
	}

	public function add001(){
		$sql = "insert into persona (tipo_documento,documento,nombre,direccion,tipo,fecha_creada,estado_civil,num_reserva) ";
		$sql .= "value ($this->tipo_documento,\"$this->documento\",\"$this->nombre\",\"$this->direccion\",1,$this->fecha_creada,\"$this->estado_civil\",\"$this->num_reserva\")";
		return Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto PersonaData previamente utilizamos el contexto
	...
	public function updateMotivo(){
		$sql = "update ".self::$tablename." set motivo=\"$this->motivo\" where id=$this->id";
		Executor::doit($sql); 
	}
	...
	public function updateHbitacion(){
		$sql = "update ".self::$tablename." set id_habitacion=\"$this->nombre\" where id=$this->id";
		Executor::doit($sql); 
	}
	...
	public function updateclienteProceso(){
		$sql = "update ".self::$tablename." set tipo_documento=$this->tipo_documento,documento=\"$this->documento\",giro=\"$this->giro\",nombre=\"$this->nombre\",direccion=\"$this->direccion\",nacionalidad=\"$this->nacionalidad\",estado_civil=\"$this->estado_civil\",num_reserva=\"$this->num_reserva\",ocupacion=\"$this->ocupacion\",medio_transporte=\"$this->medio_transporte\",destino=\"$this->destino\",motivo=\"$this->motivo\" where id=$this->id";
		Executor::doit($sql);
	}

	public function updateclienteResidente(){
		$sql = "update ".self::$tablename." set tipo_documento=$this->tipo_documento,documento=\"$this->documento\",giro=\"$this->giro\",nombre=\"$this->nombre\",direccion=\"$this->direccion\",nacionalidad=\"$this->nacionalidad\",estado_civil=\"$this->estado_civil\",num_reserva=\"$this->num_reserva\",ocupacion=\"$this->ocupacion\",medio_transporte=\"$this->medio_transporte\",destino=\"$this->destino\",motivo=\"$this->motivo\",razon_social=\"$this->razon_social\",nacionalidad=\"$this->nacionalidad\",ocupacion=\"$this->ocupacion\",destino=\"$this->destino\",telefono=\"$this->telefono\",celular=\"$this->celular\",alergia=\"$this->alergia\" where id=$this->id";
		Executor::doit($sql);
	}
	...
	public function updateclientemex(){
		$sql = "update ".self::$tablename." set tipo_documento=$this->tipo_documento,documento=\"$this->documento\",nombre=\"$this->nombre\",estado_civil=\"$this->estado_civil\",num_reserva=\"$this->num_reserva\",direccion=\"$this->direccion\" where id=$this->id";
		Executor::doit($sql);
	} 

	public function updateclientenuevo(){
		$sql = "update ".self::$tablename." set tipo_documento=$this->tipo_documento,documento=\"$this->documento\",nombre=\"$this->nombre\",estado_civil=\"$this->estado_civil\",num_reserva=\"$this->num_reserva\",giro=\"$this->giro\",direccion=\"$this->direccion\",fecha_nac=\"$this->fecha_nac\",motivo=\"$this->motivo\" where id=$this->id";
		Executor::doit($sql);
	}

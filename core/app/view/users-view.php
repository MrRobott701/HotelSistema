  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>REGISTRO DE USUARIOS</strong></h1>
        <ul class="controls">
          <li class="remove">
            <a  data-toggle="modal" data-target="#myModal"  ><i class="fa fa-user-plus"></i> REGISTRAR NUEVO USUARIO</a>
          </li>
          <li class="dropdown">
            ...
            <th></th>
                   ...
                   <?php foreach($users as $user):?>
                      <tr>
                        ...
                        <td>
                        <a href="index.php?view=deluser&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar</a>
                        </td>
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select  data-placeholder="..."  name="is_admin"

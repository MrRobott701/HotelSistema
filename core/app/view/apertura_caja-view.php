...
<!-- tile -->
                            <section class="tile  col-md-12">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>CAJAS ABIERTAS EN FECHAS DE HOY</strong></h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body p-0">
                                    ...
                                    <div class="col-lg-12 col-md-12" style="padding:12px;">
                                            ...
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item"><span class="badge bg-greensea">$   <?php echo number_format($cajas->monto_apertura,2,'.',','); ?></span> FONDO DE CAJA</li>
                    ...
                    ?>
                              ...
                              if(@count($reporproducts_es)>0){ ?>
                                  <?php foreach($reporproducts_es as $reporproduct_e):?>
                                      <?php $subtotal1=0*$reporproduct_e->precio; ?>
                            ...
                            <?php $egreso=$total_trabajador+$total_comision+$subtotal4+$total_sin_cerrar_egreso; ?>
                                                ...
                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($egreso,2,'.',','); ?></span> EGRESOS</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($total_otros_ingresos,2,'.',','); ?></span> OTROS INGRESOS</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($ingreso_efectivo,2,'.',','); ?></span> EFEC. HAB.</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($ingreso_efectivo_prod,2,'.',','); ?></span> EFEC. PROD.</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($ingreso_efectivo+$ingreso_efectivo_prod,2,'.',','); ?></span> VENTA EFEC.</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format(($ingreso_efectivo+$ingreso_efectivo_prod)-$egreso+$total_otros_ingresos+$cajas->monto_apertura,2,'.',','); ?></span> EFEC. CAJA</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format($ingreso-($ingreso_efectivo+$ingreso_efectivo_prod)+$total_otros_ingresos_tarjeta,2,'.',','); ?></span> VENTA TARJ.</li>

                                                <li class="list-group-item"><span class="badge bg-greensea">$    <?php echo number_format(($ingreso-$egreso)+$total_otros_ingresos+$cajas->monto_apertura+$total_otros_ingresos_tarjeta,2,'.',','); ?></span> VENTA TOTAL</li>

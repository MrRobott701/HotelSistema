...
<div class="row">
  ...
  <div class="col-md-2">
      <section class="tile">
        ...
        <div class="tile-body">
          <div class="row">
          <?php $habitaciones = HabitacionData::getLimpieza();  
  ...
  <form action="index.php?view=addasignacion" method="post">
  <div class="col-md-8">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
             ...
             <?php foreach($tiempos as $tiempo):?>
                <tr>
                  ...
                  <?php foreach($users as $user):?>
                      ...
                      <?php }else{ ?>
                        <td><input type="text" name="id_habitacion[]" value="<?php echo $dhab; ?>" id="id_habitacion<?php echo $user->id; ?>" style="width: 40px;"></td>
                      <?php }; ?>

                      <input type="hidden" name="estado[]" value="<?php echo $destado; ?>" id="estado<?php echo $user->id; ?>" style="width: 40px;">

                      <td><input type="text" name="tipo[]" value="<?php echo $dtipo; ?>" id="tipo<?php echo $user->id; ?>" style="width: 40px;"></td>

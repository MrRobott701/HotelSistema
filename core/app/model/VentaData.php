...
class VentaData {
	...
	public function addCompra_add_whit_image(){
		$sql = "insert into venta (id_tipo_comprobante,nro_comprobante,id_proveedor,id_tipo_pago,tipo_operacion,total,id_usuario,id_caja,fecha_creada,nro_credito,credito,imagen) ";
		$sql .= "value ($this->id_tipo_comprobante,\"$this->nro_comprobante\",$this->id_proveedor,$this->id_tipo_pago,2,\"$this->total\",$this->id_usuario,$this->id_caja,$this->fecha_creada,$this->nro_credito,$this->credito,\"$this->imagen\")";
		return Executor::doit($sql);
	} 

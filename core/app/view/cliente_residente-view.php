  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>DIRECTORIO DEL CLIENTES RESIDENTES</strong></h1>
        <ul class="controls">
          <li class="remove">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select name="medio_transporte" required class="form-control">
                        <option value="Empresa" <?php if($cliente->medio_transporte=="Empresa"){ echo "selected";}?>>Empresario</option>
                        <option value="Natural" <?php if($cliente->medio_transporte=="Natural"){ echo "selected";}?>>Normal</option>
                      </select>
                    </div>
                  </div>

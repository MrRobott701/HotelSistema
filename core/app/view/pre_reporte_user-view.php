...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE POR RECEPCIONISTA
        
      </h3> 
      <ol class="breadcrumb">
        <li><a href="index.php?view=reserva"><i class="fa fa-home"></i> Inicio</a></li>
        <li><a href="#">Reportes</a></li>
        <li class="active">REPORTE POR RECEPCIONISTA</li>
      </ol>
</section>
</div>
...
<form method="post" action="index.php?view=reporte_user" >
                                <div class="tile-body">
                                    ...
                                    <h4 class="custom-font"><strong>Fecha Inicio</strong></h4>
                                    <input type="date" class="typeahead form-control" name="start" value="<?php echo $hoy; ?>">

                                    <h4 class="custom-font"><strong>Fecha Fin</strong></h4>
                                    <input type="date" class="typeahead form-control" name="end" value="<?php echo $hoy; ?>">
                                    
                                    <h4 class="custom-font"><strong>Selecciona Recepcionista</strong></h4>

...
<section class="tile tile-simple col-md-6 col-md-offset-3">
            ...
            <div class="tile-widget dvd dvd-btm" style="text-align: center;">
              <a href="index.php?view=newingreso"  class="btn btn-sm btn-success btn-flat" style="border-bottom-left-radius: 20px; border-top-left-radius: 20px;" ><b style="font-size: 28px;">Ingreso</b></a>
              <a href="index.php?view=newegreso"  class="btn btn-sm btn-success btn-flat" style="border-bottom-right-radius: 20px;border-top-right-radius: 20px;background-color: #818181;border-color: #818181;"><b style="font-size: 28px;">Egreso</b></a>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
            <form method="post"  action="index.php?view=addnewingreso" id="addcaja">

...
if (isset($_GET['id']))//codigo elimina un elemento del array
{
	...
	$del->del();
		...
		$tmps = TmpData::getAllTemporalCompra($session_id);
            ...
            <tr style="background-color: #f3f3f3;">
                <td colspan=4><span class="pull-right">IVA 
                  
<input name="checkbox" type="checkbox" onClick="if (this.checked) sumar(<?php echo number_format($sumador_total-($sumador_total/1.18),2,'.',',');?>); else restar(<?php echo number_format($sumador_total-($sumador_total/1.18),2,'.',',');?>)" value="checkbox">

<input type="hidden" name="stotal" id="stotal" value="<?php echo number_format($sumador_total,2,'.',',');?>">
            ...
            <tr style="background-color: #e4e4e4;">
                ...
                <td><span class="pull-left" id="nombre"><?php echo number_format($sumador_total,2,'.',',');?></span></td>
                <td></td>
            </tr>
            </form>
...
total += valor;
var demoValue = document.getElementById('stotal').value;
document.getElementById('nombre').textContent = parseFloat(total)+parseFloat(demoValue);

                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                           <?php $final= $total;?>
                                                            ...
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">IVA:</strong>  $   <?php echo number_format($final*$iva_sp,2,'.',','); ?></li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5"> Total:</strong>  $  <?php echo number_format($final+($final*$iva_sp),2,'.',','); ?></li>

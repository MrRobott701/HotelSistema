        ...
        <div class="tile-body">
          <div class="row"> 
            <div class="col-md-12"> 
              ...
              <form action="index.php?view=addmantenimiento" method="post">
  ...
  <div class="col-md-12">
      <section class="tile">
        <div class="tile-header dvd dvd-btm">  
          <h1 class="custom-font"><strong>MANTENIMIENTOS<?php echo $user->name;  ?></strong>  </h1>
                  
        </div>
        <div class="tile-body">
          <div class="row"> 
          <?php $tareas = ExtraData::getAllHoyUserMM($hoy,$user->id);  
          if(@count($tareas)>0){ ?>
                  ...
                  <div class="col-md-12" style="padding-top: 15px;"> 
                    ...
                    <div class="form-group col-md-2 col-xs-4"> 
                       <?php if($tarea->estado=='0'){  ?>
                        <form action="index.php?view=updatemto" method="post" id="myform">
                        ...
                        <?php }else if($tarea->estado=='1'){  ?>
                          <form action="index.php?view=finmto" method="post" >
                              <input type="hidden" name="id" value="<?php echo $tarea->id; ?>">
